...
import com.xoptimal.photopicker.adapter.ExPhotoPagerAdapter;
 ...
 * Description:
 */
public class ExImagePagerFragment extends Fragment {
    ...
    private ExPhotoPagerAdapter mPagerAdapter;
    ...
    public static ExImagePagerFragment newInstance(List<String> paths, int currentItem) {

        ExImagePagerFragment f = new ExImagePagerFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new ExPhotoPagerAdapter(Glide.with(this), paths);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewPager = (ViewPager) rootView.findViewById(me.iwf.photopicker.R.id.vp_photos);
    ...
    private void runEnterAnimation() {
        ...
        ObjectAnimator colorizer = ObjectAnimator.ofFloat(ExImagePagerFragment.this,
                "saturation", 0, 1);
    ...
    public void runExitAnimation(final Runnable endAction) {
        ...
        ObjectAnimator colorizer =
                ObjectAnimator.ofFloat(ExImagePagerFragment.this, "saturation", 1, 0);
        colorizer.setDuration(duration);
        colorizer.start();
    }
    ...
    public void setPagerListener(ImagePagerListener pagerListener) {
        mPagerListener = pagerListener;
        mPagerAdapter.setPagerListener(mPagerListener);
    }
