 ...
 * Description:
 */
public class ExPhotoGridAdapter extends SelectableAdapter<ExPhotoGridAdapter.PhotoViewHolder> {
    ...
    public ExPhotoGridAdapter(Context context, RequestManager requestManager, List<PhotoDirectory> photoDirectories) {
    ...
    public ExPhotoGridAdapter(Context context, RequestManager requestManager, List<PhotoDirectory> photoDirectories, ArrayList<String> orginalPhotos, int colNum, boolean showSingle) {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            if (mShowSingle) {
                ...
                holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (mItemClickListener != null) {
                            mItemClickListener.onClickPhoto(photo.getPath());
                        }
                    }
                });
            } else {
                ...
                holder.fl_container.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        int     pos      = holder.getAdapterPosition();
                        ...
                        if (mItemClickListener != null) {
                            mItemClickListener.onChangeItem();
                        }
                    }
                });
            }
    ...
    private ExPhotoPickerFragment.OnItemClickListener mItemClickListener;

    public void setOnItemChangListener(ExPhotoPickerFragment.OnItemClickListener listener) {
